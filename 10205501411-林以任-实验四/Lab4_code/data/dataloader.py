import torch
from data.my_dataset import PredDataset, BartDataset, BartDatasetWord
...
def build_word_bart_dataloader(args, meta_data, shuffle=True):
    data_dataset = BartDatasetWord(meta_data, max_length=args.encode_max_length, vocab_size=args.vocab_size)
    data_loader = torch.utils.data.DataLoader(data_dataset,
                                              batch_size=args.batch_size,
                                              shuffle=shuffle,
                                              pin_memory=False,
